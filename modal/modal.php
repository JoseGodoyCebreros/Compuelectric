...
<div id="modales-container">
    <?php 
    $registros = array_merge($porteros, $intercom, $placas, $vportero, $robotica);
            ...
            <div class="modal-principal" role="document">
                <div class="modal--header">
                    <div class="modal--header-container">
                        <p class="modal-title"> <?php echo $registro['nombrePortero'] ?? $registro['nombreCompleto'] ?? $registro['nombreCompletoPlaca'] ?? $registro['nomCom_vportero'] ?? $registro['nomRobotica']?></p>
                ...
                <div class="modal-footer">
                    ...
                    <?php echo $registro['nombrePortero'] ?? $registro['nombreCompleto'] ?? $registro['nombreCompletoPlaca'] ?? $registro['nomCom_vportero'] ?? $registro['nomRobotica']?>:">PEDIR</a>
                </div>
            </div>
        </div>
    <?php
